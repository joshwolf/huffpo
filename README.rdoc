...
ASSUMPTIONS/ADJUSTMENTS: I'm not validating item name uniqueness. I used SecureRandom to generate guids for things. I also stored info on auctions in a simple hash in AuctionHouse. I'm also returning leading bid info on open auctions as well as winning bids on closed ones.
